...
# def carga_trib(preco, custo,lucro):
#     resultado = preco - custo - lucro
#     return resultado / preco

# print(carga_trib(preco, custo,lucro))
...
# def padron_cod(lista_cod, padrao="M"):
...
# lista = filtrar_lista_texto(listas_gmails, 'gmail')
# print(lista)
...
#sua function aqui
# def caulculo_stockout(dicionario_vendas):
#     numerador = 0
#     denominador = 0
#     for chave in dicionario_vendas:
#         valor,status,motivo = dicionario_vendas[chave]
#         if status == 'Concluído':
#             denominador += valor
